...
test('buildRunCardMetaLabels keeps execution and observability labels in activity cards', () => {
  const labels = buildRunCardMetaLabels({
    ...
    executionIsolationLabel: 'Guarded isolation',
    runtimeWarningLabel: 'Container Fast is not advertised for Local Host.',
  ...
  assert.deepEqual(labels, [
    ...
    'Guarded isolation',
    'Container Fast is not advertised for Local Host.',
    'via daemon-task',
    'Snapshot-backed',
    'Validation failed',
    'Needs attention',
